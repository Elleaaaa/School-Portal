                                 ...
                                 @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="gender" class="form-control" required>
                                                    ...
                                                    <option value="Female" {{ (isset($cashier->gender) && $cashier->gender == 'Female') ? 'selected' : '' }}>Female</option>
                                                    <option value="Male" {{ (isset($cashier->gender) && $cashier->gender == 'Male') ? 'selected' : '' }}>Male</option>
                                                    <option value="Others" {{ (isset($cashier->gender) && $cashier->gender == 'Others') ? 'selected' : '' }}>Others</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6 col-md-3">
                                        ...
                                        <div class="col-12 col-sm-6 col-md-3">
                                            <div class="form-group">
                                                <label>Age</label>
                                                <input name="age" type="text" class="form-control" value="{{ $cashier->age ?? '' }}" readonly>
                                            </div>
                                        </div>
