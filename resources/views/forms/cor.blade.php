...
<head>
    ...
    <title>Certification Letter</title>
    <style>
...
<body>
    <div class="letter-container">
        ...
        <div class="content">
            ...
            <p class="details"><span class="tab"></span>This is to certify that <strong>{{ $name }}</strong> is
                currently enrolled in this institution as a <strong>{{ $grade}}/{{$strand}}</strong> student for the {{ $schoolyear }}.</p>

            <p><span class="tab"></span>This certification is issued upon his/her request for {{ $purpose}}.</p>
        </div>

        <div class="signature">
            <p>Certified True and Correct,<br /><br /></p>
            <p><strong>(Signature over Printed Name)</strong></p>
            <p class="OIC"><em>OIC-Principal</em></p>
        </div>
