            ...
            <div class="content container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" action="{{ route('profile-superadmin.update', ['supAdminId' => $supAdmin->supAdminId]) }}" enctype="multipart/form-data">
                                 @csrf
                                    <div class="row">
                                        <div class="col-12">
                                        ...
                                        <div class="col-12 col-sm-6 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input name="firstName" type="text" class="form-control" value="{{ $supAdmin->firstName ?? '' }}" required>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6 col-md-3">
                                            <div class="form-group">
                                                <label>Middle Name</label>
                                                <input name="middleName" type="text" class="form-control"value="{{ $supAdmin->middleName ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6 col-md-3">
                                            <div class="form-group">
                                                <label>Last Name</label><span style="color: red;">*</span>
                                                <input name="lastName" type="text" class="form-control" value="{{ $supAdmin->lastName ?? '' }}" required>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input name="suffixName" type="text" class="form-control"
                                                    placeholder="Jr, Sr, III, etc" value="{{ $supAdmin->suffix ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6 col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-12 col-sm-6 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="gender" class="form-control" required>
                                                    ...
                                                    <option value="Female" {{ (isset($supAdmin->gender) && $supAdmin->gender == 'Female') ? 'selected' : '' }}>Female</option>
                                                    <option value="Male" {{ (isset($supAdmin->gender) && $supAdmin->gender == 'Male') ? 'selected' : '' }}>Male</option>
                                                    <option value="Others" {{ (isset($supAdmin->gender) && $supAdmin->gender == 'Others') ? 'selected' : '' }}>Others</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input name="birthday" type="date" class="form-control" value="{{ $supAdmin->birthday ?? '' }}" required>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6 col-md-3">
                                            <div class="form-group">
                                                <label>Age</label>
                                                <input name="age" type="text" class="form-control" value="{{ $supAdmin->age ?? '' }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                <label>Mobile Number</label><span style="color: red;">*</span>
                                                <input name="mobileNumber" type="text" class="form-control" value="{{ $supAdmin->mobileNumber ?? '' }}" required>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                <label>Landline Number</label>
                                                <input name="landlineNumber" type="text" class="form-control" value="{{ $supAdmin->landlineNumber ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                <label>Religion</label>
                                                <input name="religion" type="text" class="form-control" value="{{ $supAdmin->religion ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                <label>Place of Birth</label>
                                                <input name="birthPlace" type="text" class="form-control" value="{{ $supAdmin->placeOfBirth ?? '' }}">
                                            </div>
                                        </div>
