            ...
            <div class="content container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" action="{{ route('profile-admin.update', ['id' => $admin->id]) }}" enctype="multipart/form-data">
                                 @csrf
                                    <div class="row">
                                        <div class="col-12">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <img src="{{ asset('storage/images/display-photo/' . $admin->displayPhoto) }}"  style="height: 250px">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-sm-6 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input name="middleName" type="text" class="form-control"value="{{ $admin->middleName ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6 col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-12 col-sm-6 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input name="suffixName" type="text" class="form-control"
                                                    placeholder="Jr, Sr, III, etc" value="{{ $admin->suffix ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6 col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input name="landlineNumber" type="text" class="form-control" value="{{ $admin->landlineNumber ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                <label>Religion</label>
                                                <input name="religion" type="text" class="form-control" value="{{ $admin->religion ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                <label>Place of Birth</label>
                                                <input name="birthPlace" type="text" class="form-control" value="{{ $admin->placeOfBirth ?? '' }}">
                                            </div>
                                        </div>
