                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input name="address" type="text" class="form-control"
                                                    placeholder="house no., blk/lot, subd/vill" value="{{ old('address') }}">
                                            </div>
                                        </div>
