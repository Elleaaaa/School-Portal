  ...
  <div class="container">
    <div class="row mb-5">
      <div class="col-md-6 mb-4 mb-md-0">
        <img class="img-fluid" src="{{ asset('images/website/scholarship/scholarship.jpg') }}" alt="scholarship news">
      </div>
      <div class="col-md-6">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
        <div class="card rounded-0 hover-shadow border-top-0 border-left-0 border-right-0">
          <img class="card-img-top rounded-0" src="{{ asset('images/website/scholarship/scholarship-item-1.jpg') }}" alt="scholarship-thumb">
          <div class="card-body">
      ...
      <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
        <div class="card rounded-0 hover-shadow border-top-0 border-left-0 border-right-0">
          <img class="card-img-top rounded-0" src="{{ asset('images/website/scholarship/scholarship-item-2.jpg') }}" alt="scholarship-thumb">
          <div class="card-body">
      ...
      <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
        <div class="card rounded-0 hover-shadow border-top-0 border-left-0 border-right-0">
          <img class="card-img-top rounded-0" src="{{ asset('images/website/scholarship/scholarship-item-3.jpg') }}" alt="scholarship-thumb">
          <div class="card-body">
            <p class="mb-1">Design & Arts</p>
